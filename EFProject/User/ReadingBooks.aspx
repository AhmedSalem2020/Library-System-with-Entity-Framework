<%@ Page Title="" Language="C#" MasterPageFile="~/User/USer.Master" AutoEventWireup="true" CodeBehind="ReadingBooks.aspx.cs" Inherits="EFProject.User.ReadingBooks" %>
                    ...
                    <form action="../ErrorPage/error.aspx" method="POST">
                        <div class="col-md-12">
                            <div class="search-filter">
                                ...
                                <input type="text" class="form-control keyword" name="book" id="txt_name" runat="server" placeholder="Book Name">
                                <!--End Search Filter-->

                                <!--Start Search Location Options-->
                                <input type="text" class="form-control keyword" name="author" id="txt_aut" runat="server" placeholder="Author Name">
                                <!--End Search Location Options-->

                                <!--Start Search Category Options-->
                                <input type="text" class="form-control keyword" name="publisher" id="txt_cat" runat="server" placeholder="Publisher Name">
                                <!--End Search Category Options-->

                                <!--Start Search Button-->
                                <div class="search-btn">
                                    <button  id="btn_src" runat="server">Search</button> 
                                </div>
                                <!--End Search Button-->
                            </div>
                        </div>
    ...
    <p>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Larger" Font-Underline="True" Text="Search By Month" ForeColor="Red" BorderStyle="None" Width="258px"></asp:Label>
                        <br />
                        <br />
                    </td>
                    <td>
                        <asp:DropDownList ID="ddl_month" runat="server" AutoPostBack="True" Height="16px" OnSelectedIndexChanged="ddl_month_SelectedIndexChanged" Width="76px" Font-Bold="True" Font-Size="Medium" ForeColor="#9933FF">
                        </asp:DropDownList>
                        <br />
                        <br />
                    </td>
                ...
                <tr>
                    <td class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Larger" Font-Strikeout="False" Font-Underline="True" Text="Search By Year&nbsp;" BorderStyle="None" ForeColor="Red" Width="211px"></asp:Label>
                        <br />
                        <br />
                    </td>
                    <td>
                        <asp:DropDownList ID="ddl_year" runat="server" AutoPostBack="True" Height="16px" OnSelectedIndexChanged="ddl_year_SelectedIndexChanged" Width="80px" Font-Bold="True" Font-Size="Medium" ForeColor="#CC00CC">
                        </asp:DropDownList>
                        <br />
                        <br />
                        <br />
                ...
                <tr>
                    <td class="auto-style2">
                        &nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Larger" Font-Strikeout="False" Font-Underline="False" Text="Search By Month&amp;Year&nbsp;" BorderStyle="None" ForeColor="Red" Width="293px"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txt_both" runat="server" Font-Bold="False" Font-Size="Medium" TextMode="Month"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="see" ControlToValidate="txt_both" runat="server" ForeColor="Red" ErrorMessage="Required"></asp:RequiredFieldValidator>
                ...
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <%--<asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="616px" Font-Bold="True" Font-Size="Large">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="feat-item">
                            ...
                            <div class="feat-item-cont">
                                ...
                                <p><i class="fa fa-arrow-circle-right color-main"></i><strong> deliveredDate:</strong> <%# Eval("deliveredDate") %></p>
